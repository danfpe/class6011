...
//            c.loop( 2 );
    ...
    private void createComponent() {
        ...
        AudioComponentWidgetBase acw = new SineWaveWidget(sinewave, maincavas_, "sine wave");
        widget_.add(acw);
    }
    ...
    private void createVFSineWaveComponent() {
        ...
        AudioComponentWidgetBase acw = new VFSineWaveWidget(vfgen, maincavas_, "VF Sine Wave");
        widget_.add(acw);
    }
