...
public class Adventure {
    ...
    public static void main( String[] args ) {
        ...
        Room littleHouse = new Room ("Little House", "a house connected with entrance");
        ...
        hall.addConnection( littleHouse );
        ...
        Item newItem = new Item("USB", "A shiny USB");
        littleHouse.addItem(newItem);
